...
**Scene category** (album profile), 1,861 CC BY photos from Open Images V7 in 8 groups (`data/scene/scene-v1.csv`): group correct 77.8% overall with the album profile's 40 fine labels in 8 groups plus light, setting and framing attributes ([#34](https://github.com/lincleejun/bioscan/issues/34)); every group 70% or more (macro 91%, people 90%, night 77%, wildlife 76%, architecture 75%, other 74%, landscape 71%, food 70%). The old 8 labels gave 70.6%.
