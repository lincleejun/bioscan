...
**Scene category** (album profile), 1,861 CC BY photos from Open Images V7 in 8 groups (`data/scene/scene-v1.csv`): group correct 74.9% overall with the album profile's 40 fine labels in 8 groups plus light, setting and framing attributes ([#34](https://github.com/lincleejun/bioscan/issues/34)): wildlife 93%, people 90%, night 76%, architecture 75%, other 71%, food 70%, landscape 69%, macro 47% (fungi and plants read as animals, [#46](https://github.com/lincleejun/bioscan/issues/46)). The old 8 labels gave 70.6%.
