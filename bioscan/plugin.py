...
class Manifest:
    ...
    # stage. Stages built after A0 set it; identify, embed, jpg and geotag leave it off, so their
    # streams stay byte-identical (identify's settings are engine.settings).
